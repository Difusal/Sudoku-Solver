...
void Control::CreateAllegroDisplay(bool FullScreenMode) {
	...
	if (!display) {
		al_show_native_message_box(display, "Error", "Display Settings",
				"Couldn't create a display.\nQuitting program.", NULL,
...
void Control::DisplayLoadingSplashScreen() {
	...
	// printing text
	al_draw_text(largeFont, Black, ScreenWidth / 2.0 + 1,
			ScreenHeight / 2.0 + 2, ALLEGRO_ALIGN_CENTER, "Loading...");
	al_draw_text(largeFont, White, ScreenWidth / 2.0, ScreenHeight / 2.0,
